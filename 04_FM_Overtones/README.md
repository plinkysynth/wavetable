...
In this set, the waves were chosen for their rich overtones, making sweeps through the waveforms more variable in timbre. The resulting sounds have an emphasis in midrange harmonics, and can have a sparkly top end. This set of waves has strong vibes of retro-classic 8-bit gaming.
