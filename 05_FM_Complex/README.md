...
In this set, the waves were designed to have stronger individual characteristics, like pulses, edges and intervals within the wave. The resulting sounds are interesting to use in achord context, as they bring their own harmonic material to the table. Some of the waveforms tend to sound glassy, others overtone-rich like C64 variants of square waveforms. 
