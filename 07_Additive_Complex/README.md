...
In this set, the overtones for the waves were randomized. The result is the most varied wavetable set of the ones generated using the additive method, however in comparison to the FM wavetable banks, it still remains relatively mild and suitable for chords and harmonies.
